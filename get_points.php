...
$mylat = floatval($_POST["mylat"]);

$mylng = floatval($_POST["mylng"]);
...
$select = "SELECT id, lat,lng FROM poi";
...
while ($row = $result->fetch_assoc())
	
	{
		...
		//ypologismos apostasis metaksy tis trexousas topothesias kai tou antistoixoy poi
	   ...
	   array_push($latlng,intval($mydist));
